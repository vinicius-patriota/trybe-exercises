...
for (let i in basket) {
    ...
    if (repeated === false) {
        ...
        organizedBasket[basket[i]] = count;
    };
...
for (let key in organizedBasket) {
    presentation += organizedBasket[key] + " " + key + "(s), ";
};

presentation = presentation.slice(0, -2);

console.log("Sua cesta possui: " + presentation);